...
const Experience = () => {
  return (
    <div id="experience" className="bg-stone-700 px-48 rounded-2xl">
      <div className="py-8">
        <h1 className="text-4xl font-semibold">Experience</h1>
        <div className="py-10 flex gap-5">
          <p className="  h-1/2 p-2">March 2021</p>
          ...
          <div className="flex flex-col gap-3">
            ...
            <p className="">
              ...
              dicta laborum ullam, quasi soluta eligendi nesciunt nulla officia
